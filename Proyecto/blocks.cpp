...
public:
    ...
    void CustomBehaviour(int keyPresed) const override
    {
        const_cast<IBlock *>(this)->SetGravity(12.2);
        switch (keyPresed)
        {
            case 0:
    ...
    void UndoCustomBehaviour(int keyPresed) const override
    {
        const_cast<IBlock *>(this)->SetGravity(9.8);
        switch (keyPresed)
        {
            case 0:
                const_cast<IBlock *>(this)->Move(-1, 0);
...
public:
    ...
    void CustomBehaviour(int keyPresed) const override {
        const_cast<OBlock *>(this)->SetGravity(12.6);
    };
    void UndoCustomBehaviour(int keyPresed) const override {
        const_cast<OBlock *>(this)->SetGravity(9.8);
    };
};
...
public:
    ...
    void CustomBehaviour(int keyPresed) const override {
        const_cast<SBlock *>(this)->SetGravity(8.8);
    };
    void UndoCustomBehaviour(int keyPresed) const override {
        const_cast<SBlock *>(this)->SetGravity(9.8);
    };
};
