...
Game::Game()
{
    ...
    level = 1;
    InitAudioDevice();
    music = LoadMusicStream("/Users/exponentiadev/Desktop/TetrisProject/Tetris/Tetris/scr/Sounds/music.mp3");
    //PlayMusicStream(music);
    rotateSound = LoadSound("/Users/exponentiadev/Desktop/TetrisProject/Tetris/Tetris/scr/Sounds/rotate.mp3");
    clearSound = LoadSound("/Users/exponentiadev/Desktop/TetrisProject/Tetris/Tetris/scr/Sounds/clear.mp3");
}
...
Game::~Game()
{
    ...
    delete grid; // Liberar la memoria de la instancia de Grid
